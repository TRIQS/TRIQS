...
namespace triqs {
  namespace operators {
    ...
    struct canonical_ops_t {
      ...
      template <class Archive> void serialize(Archive &ar, unsigned int = 0) { ar & dagger & indices; }
    };
  ...
  */
      ...
      template <class Archive> void serialize(Archive &ar, unsigned int = 0) { ar & monomials; }
